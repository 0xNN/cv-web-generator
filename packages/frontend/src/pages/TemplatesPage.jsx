...
const templates = [
  ...
  { id: 'tech-it', name: 'Tech Industry', category: 'Teknologi', description: 'Template khusus untuk industri teknologi. Tampilkan skill dan proyekmu.', pro: true },
  { id: 'corporate-finance', name: 'Finance Professional', category: 'Keuangan', description: 'Desain formal dan profesional untuk industri keuangan dan perbankan.', pro: true },
  { id: 'creative-design', name: 'Creative Portfolio', category: 'Kreatif', description: 'Tampilkan portofoliomu dengan layout yang unik dan artistik.', pro: true },
];
      ...
      <div className="templates-grid">
        {templates.map((t) => (
          <div key={t.id} className={`template-card card ${t.pro ? 'template-pro' : ''}`}>
            ...
            <div className={`template-preview preview-${t.id}`}>
